package com.copytrading.sources.binance.copytradingleaderboard;

import com.copytrading.sources.binance.copytradingleaderboard.model.request.*;
import com.copytrading.sources.binance.copytradingleaderboard.model.response.ResponseEntity;
import com.copytrading.sources.binance.copytradingleaderboard.model.response.details.TraderDetails;
...
import com.copytrading.sources.binance.copytradingleaderboard.model.response.performance.TraderPerformance;
import com.copytrading.sources.binance.copytradingleaderboard.model.response.positions.active.ActivePositions;
import com.copytrading.sources.binance.copytradingleaderboard.model.response.positions.active.PositionData;
import com.copytrading.sources.binance.copytradingleaderboard.model.response.positions.history.PositionHistory;
