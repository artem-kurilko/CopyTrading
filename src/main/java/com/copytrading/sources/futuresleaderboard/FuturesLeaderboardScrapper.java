...
public class FuturesLeaderboardScrapper {
    ...
    public static TraderPositions getTraderPositions(String encryptedUid) throws IOException {
        ...
        httpConn.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:124.0) Gecko/20100101 Firefox/124.0");
        ...
        httpConn.setRequestProperty("Referer", "https://www.binance.com/en/futures-activity/leaderboard/user/um?encryptedUid=FEC1C474341CF211AE965466C8A6D26B");
        httpConn.setRequestProperty("lang", "en");
        httpConn.setRequestProperty("x-ui-request-trace", "8ff1b4ab-486c-44c0-82ab-66f9be1505b5");
        httpConn.setRequestProperty("x-trace-id", "8ff1b4ab-486c-44c0-82ab-66f9be1505b5");
        httpConn.setRequestProperty("bnc-uuid", "5479519b-922b-4027-b382-c1c1e9651633");
        httpConn.setRequestProperty("content-type", "application/json");
        httpConn.setRequestProperty("device-info", "");
        httpConn.setRequestProperty("clienttype", "web");
        httpConn.setRequestProperty("fvideo-id", "3365a86b00d7a827a9abdf1ca915103153252fdf");
        httpConn.setRequestProperty("fvideo-token", "L1izD8LiPKZ7jIPeCbVWX47+ximyuiBDjMHpWgwxPATzDRLlgQYjGkbZUiI/o/1QGzQG2Ta0tavnfEJoBEBg0noi48XTaeqY2967f6+Zbb/Wed+jrbGQnyCo07oxTosLsoFJy5ii6vaLvdkDhESwHSS8ODiJ+/hji67jdB67qiV3lgNKiYMGOD4xjUSZuKgAg=25");
